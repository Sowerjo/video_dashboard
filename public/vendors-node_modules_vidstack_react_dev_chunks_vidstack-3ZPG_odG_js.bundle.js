"use strict";
(global["webpackChunkvideo_dashboard_app"] = global["webpackChunkvideo_dashboard_app"] || []).push([["vendors-node_modules_vidstack_react_dev_chunks_vidstack-3ZPG_odG_js"],{
...
class HLSController {
  ...
  #createDOMEvent(type, data) {
    return new _vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.DOMEvent(toDOMEventType(type), { detail: data });
  }
  #liveSync() {
  ...
  #onError(eventType, data) {
    {
      this.#ctx.logger?.errorGroup(`[vidstack] HLS error \`${eventType}\``).labelledLog("Media Element", this.#instance?.media).labelledLog("HLS Instance", this.#instance).labelledLog("Event Type", eventType).labelledLog("Data", data).labelledLog("Src", (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.peek)(this.#ctx.$state.source)).labelledLog("Media Store", { ...this.#ctx.$state }).dispatch();
    }
    if (data.fatal) {
      switch (data.type) {
        case "mediaError":
...
class HLSLibLoader {
  ...
  #onLoaded(ctor) {
    ...
    this.#ctx.player.dispatch(
      new _vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.DOMEvent("hls-lib-loaded", {
        detail: ctor
      })
    );
    this.#callback(ctor);
  ...
  #onLoadError(e) {
    ...
    this.#ctx.player.dispatch(
      new _vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.DOMEvent("hls-lib-load-error", {
        detail: error
      })
    );
    this.#ctx.notify("error", {
...
class HLSProvider extends _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_2__.VideoProvider {
   ...
   */
  static supported = (0,_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_2__.isHLSSupported)();
  get type() {
    return "hls";
  }
  get canLiveSync() {
...
//# sourceMappingURL=vendors-node_modules_vidstack_react_dev_chunks_vidstack-3ZPG_odG_js.bundle.js.map